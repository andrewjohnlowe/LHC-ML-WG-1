...
```{r screwdriver, fig.align='center', fig.height=8, fig.width=8, echo=FALSE, message = FALSE, warning = FALSE, error = FALSE}
require(png)
require(grid)
img <- readPNG("screwdriver.png")
grid.raster(img)
```

---
### Sometimes I want to use:
```{r scalpel, fig.align='center', fig.height=8, fig.width=8, echo=FALSE, message = FALSE, warning = FALSE, error = FALSE,cache=TRUE}
require(png)
require(grid)
img <- readPNG("scalpel.png")
grid.raster(img)
```

---
### Or sometimes:
```{r hammer, fig.align='center', fig.height=8, fig.width=8, echo=FALSE, message = FALSE, warning = FALSE, error = FALSE,cache=TRUE}
require(png)
require(grid)
img <- readPNG("hammer.png")
grid.raster(img)
```

---
### What ROOT provides
```{r swiss, fig.align='center', fig.height=8, fig.width=8, echo=FALSE, message = FALSE, warning = FALSE, error = FALSE,cache=TRUE}
require(png)
require(grid)
img <- readPNG("swiss.png")
grid.raster(img)
```
